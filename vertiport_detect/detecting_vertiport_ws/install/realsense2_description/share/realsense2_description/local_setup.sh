...
: ${AMENT_CURRENT_PREFIX:="/home/haechan/Repo_2025/machine_AI/cv_uav_control_for_landing/vertiport_detect/detecting_vertiport_ws/install/realsense2_description"}
